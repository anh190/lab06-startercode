...
class TestPyFuncs05(unittest.TestCase):   
    ...
    def test_sumOdds_1(self):
        self.assertEqual( sumOdds([]),0)

    def test_sumOdds_2(self):
        self.assertEqual( sumOdds([2]),0)

    def test_sumOdds_3(self):
        self.assertEqual( sumOdds([3]),3)

    def test_sumOdds_4(self):
        self.assertEqual( sumOdds((10,21,30)),21)

    def test_sumOdds_5(self):
        self.assertEqual( sumOdds((10,21,30,43)),64)

    def test_sumOdds_6(self):
        self.assertEqual( sumOdds((17,21,39,43)),120)

    def test_sumOdds_7(self):
        self.assertEqual( sumOdds((10,20,30,44)),0)

    def test_sumOdds_8(self):
        # This is what a test case looks like when you
        # expect that an error will happen
        with self.assertRaises(TypeError):
            x = sumOdds(12)

    def test_sumOdds_9(self):
        # This is what a test case looks like when you
        # expect that an error will happen
        with self.assertRaises(TypeError):
            x = sumOdds("UCSD")    
